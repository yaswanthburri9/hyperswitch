...
pub struct MerchantAccount {
    ...
    pub webhook_details: Option<Vec<Option<diesel_models::business_profile::WebhookDetails>>>,
...
pub enum MerchantAccountUpdate {
    Update {
        ...
        webhook_details: Option<Vec<Option<diesel_models::business_profile::WebhookDetails>>>,
